...
;; This file is based on SSAX's input-parse.scm, and is in the public
;; domain.
...
;; include an EOF "character", which is to be coded as symbol *eof*
;;
...
;; key 'parser-error. The arguments will be of the form
;;
;;   (PORT MESSGE SPECIALISING-MSG*)
;;
...
;; Guile note: I played around with the different settings (static vs
;; newly-allocated, shared substrings, etc) and I couldn't get it any
;; faster than it already is. -- Andy Wingo
